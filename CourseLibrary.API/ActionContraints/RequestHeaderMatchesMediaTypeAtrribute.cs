...
{
	public class RequestHeaderMatchesMediaTypeAtrribute : Attribute, IActionConstraint
	{
		private readonly string _requestHeaderToMatch;
		private readonly MediaTypeCollection _mediaTypes = new();

		public RequestHeaderMatchesMediaTypeAtrribute(string requestHeaderToMatch,
