...
namespace CourseLibrary.API.Services
{
	public class PropertyMappingService : IPropertyMappingService
	{
		...
		{
			_propertyMappings.Add(new PropertyMapping<Author, AuthorDto>(_authorPropertyMapping));
		}
		...
		public Dictionary<string, PropertyMappingValue> GetPropertyMapping<TSource, TDestination>()
		{
			...
			throw new Exception($"Cannot find exact property mapping instance for {typeof(TSource).Name} to {typeof(TDestination).Name}");
		}
